...
| Slide CRUD           | `getSlides`, `getSlideAt`, `getSlideIndex`, `addSlide`, `removeSlide`, `moveSlide`, `duplicateSlide`, `replaceSlideContents`, `clearSlideShapes`                                                                                                                                                                                                                                                                                                     |
...
| Shape accessibility  | `getShapeAltTitle` / `setShapeAltTitle`, `getShapeDescription` / `setShapeDescription`, `getShapeDecorative` / `setShapeDecorative`, `inspectShapeDecorative` (distinguishes absent, valid, and malformed native metadata)                                                                                                                                                                                                                           |
...
| Text frame           | `setShapeTextAnchor` / `getShapeTextAnchor`, `setShapeTextMargins` / `getShapeTextMargins`, `setShapeTextWrap` / `getShapeTextWrap`, `setShapeTextHorizontalOverflow` / `getShapeTextHorizontalOverflow`, `setShapeTextVerticalOverflow` / `getShapeTextVerticalOverflow`, `setShapeTextAnchorCentering` / `getShapeTextAnchorCentering`, `setShapeTextCompatibilityLineSpacing` / `getShapeTextCompatibilityLineSpacing`, `getShapeBodyPrEffective` |
...
| Effects              | `setShapeEffects` / `getShapeEffects` / `getShapeEffectsEffective` / `clearShapeEffects`; compatibility helpers `setShapeShadow` / `setShapeGlow` / `getShapeEffect`; exported `Effect`, `EffectBlend`, and `PresetShadow` types; `TextFormat.effects` authors the same complete editable effect list on text runs                                                                                                                                   |
